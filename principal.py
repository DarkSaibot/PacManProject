...
class Game:
    ...
    def carregar_arquivos(self):
        #Carrega os arquivos de imagem e audio
        diretorio_imagens = os.path.join(os.getcwd(), "imagens")
        self.diretorio_audios = os.path.join(os.getcwd(), "sons")
    ...
    def mostrar_tela_start(self):
        ...
        self.mostrar_texto('Desenvolvido por Gabriel Tobias', 19, constantes.BRANCO, constantes.LARGURA / 2,570)
